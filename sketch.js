...
function setup() {
  ...
  kangaroo = createSprite(470,430,40,10);
  kangaroo.addAnimation("running", kangaroo_running);
  kangaroo.addAnimation("collided", kangaroo_collided);
  kangaroo.scale = 0.20;
  kangaroo.setCollider("circle",0,70,15)

  invisibleGround = createSprite(400,530,50,10);
...
function spawnShrubs() {
  ...
  if (frameCount % 150 === 0) {
    ...
    var shrub = createSprite(camera.position.x+500,530,40,10);
...
function spawnObstacles() {
  if(frameCount % 120 === 0) {
    ...
    var obstacle = createSprite(camera.position.x+400,530,40,40);    
